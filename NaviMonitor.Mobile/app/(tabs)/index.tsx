    ...
    <SafeAreaView className="flex-1 bg-background" edges={['top']}>
      ...
      <ScrollView className="flex-1 px-6 pt-6" contentContainerStyle={{ paddingBottom: 120 }} showsVerticalScrollIndicator={false}>
        <View className="gap-4 flex-col justify-between">
          <Pressable onPress={handlePress} className="bg-surface-container-low rounded-xl p-6 border border-surface-variant w-full overflow-hidden relative active:opacity-80 active:scale-[0.98]">
          ...
          <Pressable onPress={handlePress} className="bg-surface-container-low rounded-xl p-6 border border-surface-variant w-full overflow-hidden relative mt-4 active:opacity-80 active:scale-[0.98]">
            <View className="flex-row justify-between items-start z-10">
              <View>
