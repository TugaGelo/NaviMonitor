          ...
          <React.Fragment key={milestone.km}>
            <View style={[styles.milestoneRow, isFuture && { opacity: 0.6 }]}>
              ...
              <View style={styles.nodeContainer}>
                <View style={[
                  styles.node, 
                  isCompleted ? styles.nodeCompleted : isOverdue ? styles.nodeOverdue : styles.nodeUpcoming
                ]} />
              </View>
              ...
              <View style={[styles.card, isOverdue && styles.cardOverdue]}>
                <View style={styles.cardHeader}>
                  ...
                  <View style={[styles.badge, isCompleted && styles.badgeCompleted, isOverdue && styles.badgeOverdue]}>
                    <Text style={[styles.badgeText, isCompleted && { color: '#fff' }, isOverdue && { color: '#ba1a1a' }]}>
                      {milestone.status}
                    </Text>
                  </View>
                </View>
