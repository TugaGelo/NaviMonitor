...
export default function ActionSheet({ visible, title, onEdit, onDelete, onCancel }: ActionSheetProps) {
        ...
        >
          ...
          <View className="flex flex-col w-full">
            ...
            >
              ...
              <Text className="text-[18px] text-[#1c1b1b] font-medium ml-4">Edit Vehicle</Text>
            </Pressable>
            ...
            >
              ...
              <Text className="text-[18px] text-[#b7102a] font-medium ml-4">Delete Vehicle</Text>
            </Pressable>
          </View>
